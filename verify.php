      ...
      <tr>
        ...
        <td class="container">
          <div class="content">
            ...
            Your Exam fee for Indian Airport Services has been Accepted</span>
            <table class="main">
                ...
                <td class="wrapper">
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        <p>Hi there,</p>
                        <p>We will notify you once admit cards start to roll out. </p>
                            ...
                            <tr>
                              <td align="left">
                                <table border="0" cellpadding="0" cellspacing="0">
                                  <tbody>
                                    <tr>
                                      <td> <a href="http://indiaairportservices.co.io" target="_blank">Call To Action</a> </td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
                        ...
                        <p>You will be able to collect your admit card from our own site after the selection process is done.</p>
                        <p>Good luck!</p>
                      </td>
                    </tr>
                  </table>
              ...
              <table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="content-block">
                    <span class="apple-link">india Airport Services</span>
                  </td>
                </tr>
              </table>
            </div>
...
EOL;
					...
					postmail("indiaairportservices@gmail.com","Ravindra Kumar","Payment Received",json_encode($response), $altbody);
